...
void l_altar(void)
{
    ...
    default:
        ...
        print2("Tässä rumassa alttarissa ei ole merkintöjä.");
	break;
    case ODIN:
        print1("This granite altar is graven with a gallows.");
	print1("Tähän graniittialttariin on kaiverrettu Ukonkirves.");
        break;
    case SET:
        print1("This sandstone altar has a black hand drawn on it.");
	print1("Tämä alttari on synkkä ja pelottava.");
        break;
    case HECATE:
        print1("This silver altar is inlaid with a black crescent moon.");
	print1("Musta kuunsirppi tähän alttariin kaiverrettu.");
        break;
    case ATHENA:
        print1("This golden altar is inscribed with an owl.");
	print1("Pöllön kuva tässä kulta-alttarissa.");
        break;
    case DESTINY:
        print1("This crystal altar is in the form of an omega.");
	print1("Tässä alttari on kristillinen, ja siinä on Alfa- ja Omega-symbolit.");
        break;
    case DRUID:
        print1("This oaken altar is ornately engraved with leaves.");
	print1("Tähän tammialttariin on kaiverrettu koristeellisesti lehtiä.");
        break;
    }
